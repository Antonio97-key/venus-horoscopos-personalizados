           ...
           <div className="flex justify-center gap-4">
              <button 
                ...
                className={`flex items-center gap-2 px-4 py-2 rounded-full border transition-all text-xs font-bold uppercase tracking-widest ${
                  lang === 'es' ? 'bg-cosmic-gold/20 border-cosmic-gold text-white' : 'bg-white/5 border-white/10 text-cosmic-soft hover:bg-white/10'
                }`}
              >
              ...
              <button 
                ...
                className={`flex items-center gap-2 px-4 py-2 rounded-full border transition-all text-xs font-bold uppercase tracking-widest ${
                  lang === 'en' ? 'bg-cosmic-gold/20 border-cosmic-gold text-white' : 'bg-white/5 border-white/10 text-cosmic-soft hover:bg-white/10'
                }`}
              >
