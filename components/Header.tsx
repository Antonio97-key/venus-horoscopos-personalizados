      ...
      <div className="max-w-7xl mx-auto flex items-center justify-between gap-4">
        ...
        <div className="absolute left-1/2 -translate-x-1/2 flex items-center justify-center gap-4 w-full max-w-[50%]">
          <div className="relative group shrink-0 hidden sm:flex">
            ...
            <div className="w-10 h-10 rounded-full border-2 border-cosmic-gold/30 p-1 flex items-center justify-center bg-cosmic-navy overflow-hidden">
              <span className="text-xl">✨</span>
            </div>
          </div>
          <h1 className="text-lg md:text-2xl lg:text-3xl font-display font-black text-white tracking-[-0.02em] uppercase text-center leading-none">
            VENUS <span className="text-cosmic-gold">HOROSCOPOS</span> <span className="hidden xs:inline">PERSONALIZADOS</span>
          </h1>
        </div>
